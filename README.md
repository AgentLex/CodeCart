...
* **🆕 New Cartridge**: Click left-bottom button to clear all nodes.
* **🆕 新建卡带**：点击左下角按钮，抹除所有节点，开启纯净画布。
* **⚓ Set Anchors**: In the console, enter your hard constraints.
* **⚓ 设定锚点**：在控制台输入物理级红线。--执行
  - *Example:* `+ANCHOR("Budget limit: $1000")` / `+ANCHOR("预算限额 1000 元")`--Execute
